! function () {
    ...
    var p = {
            ...
            renameFile: null,
            forceFallback: !1,
            dictDefaultMessage: "فایل خود را کشیده و اینجا رها کنید یا کلیک کنید",
            dictFallbackMessage: "مرورگر شما از قابلیت کشیدن و رها کردن پشتیبانی نمی کند",
            dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.",
            dictFileTooBig: "حجم فایل شما زیاد است ({{filesize}}MiB) . حداکثر حجم مجاز : {{maxFilesize}}MiB",
            dictInvalidFileType: "شما مجاز به ارسال فایل با این فرمت نیستید",
            dictResponseError: "سرور با کد {{statusCode}} دچار خطا شده است",
            dictCancelUpload: "لغو بارگزاری",
            dictUploadCanceled: "بارگزاری لغو شد",
            dictCancelUploadConfirmation: "آیا شما از لغو بارگزاری مطمئن هستید؟",
            dictRemoveFile: "حذف فایل",
            dictRemoveFileConfirmation: null,
            dictMaxFilesExceeded: "شما نمی توانید فایل دیگری آپلود کنید",
            dictFileSizeUnits: {
                tb: "TB",
                gb: "GB",
                mb: "MB",
            ...
            previewTemplate: e('<div class="dz-file-preview dz-preview dz-processing dz-success dz-complete"> <div class="dz-image"><img data-dz-thumbnail=""></div> <div class="dz-details"> <div class="dz-size"><span data-dz-size=""><strong>0.7</strong> MB</span></div> <div class="dz-filename"><span data-dz-name="">Help.pdf</span></div> </div> <div class="dz-progress"> <span class="dz-upload" data-dz-uploadprogress="" style="width: 100%;"></span> </div> <div class="dz-error-message"><span data-dz-errormessage=""></span></div> <div class="dz-success-mark" style="opacity: 1;"> <svg width="54" height="54" fill="#fff"><path d="m10.207 29.793 4.086-4.086a1 1 0 0 1 1.414 0l5.586 5.586a1 1 0 0 0 1.414 0l15.586-15.586a1 1 0 0 1 1.414 0l4.086 4.086a1 1 0 0 1 0 1.414L22.707 42.293a1 1 0 0 1-1.414 0L10.207 31.207a1 1 0 0 1 0-1.414Z"></path></svg> </div> <div class="dz-error-mark"> <svg width="54" height="54" fill="#fff"><path d="m26.293 20.293-7.086-7.086a1 1 0 0 0-1.414 0l-4.586 4.586a1 1 0 0 0 0 1.414l7.086 7.086a1 1 0 0 1 0 1.414l-7.086 7.086a1 1 0 0 0 0 1.414l4.586 4.586a1 1 0 0 0 1.414 0l7.086-7.086a1 1 0 0 1 1.414 0l7.086 7.086a1 1 0 0 0 1.414 0l4.586-4.586a1 1 0 0 0 0-1.414l-7.086-7.086a1 1 0 0 1 0-1.414l7.086-7.086a1 1 0 0 0 0-1.414l-4.586-4.586a1 1 0 0 0-1.414 0l-7.086 7.086a1 1 0 0 1-1.414 0Z"></path></svg> </div> </div>'),
            drop: function (e) {
