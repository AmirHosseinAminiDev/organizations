/*! Pickr 1.9.1 MIT | https://github.com/Simonwep/pickr */ ! function (t, e) {
    ...
    class E {
        ...
        static I18N_DEFAULTS = {
            ...
            "btn:swatch": "سوئیچ رنگ",
            "btn:last-color": "استفاده رنگ قبلی",
            "btn:save": "ذخیره",
            "btn:cancel": "لغو",
            "btn:clear": "پاک کردن",
            "aria:btn:save": "ذخیره و بستن",
            "aria:btn:cancel": "لغو و بستن",
            "aria:btn:clear": "پاک کردن و بستن",
            "aria:input": "فیلد ورودی رنگ",
            "aria:palette": "محیط انتخاب رنگ",
