  ...
  var x = function () {
    ...
    w = function () {
      ...
      return r(t, [{
        ...
        key: "getX1X2",
        value: function (t, e) {
          var i, a = "x1" === t ? e.x : e.x2,
            s = this.w,
            r = this.annoCtx.invertAxis ? s.globals.minY : s.globals.minX,
            o = this.annoCtx.invertAxis ? s.globals.maxY : s.globals.maxX,
            n = this.annoCtx.invertAxis ? s.globals.yRange[0] : s.globals.xRange,
            l = !1;
  ...
  var M = {
      ...
      return r(t, [{
        ...
        value: function (t, e) {
          ...
          if ("mousemove" === t.type) {
            ...
            for (var c = 0; c < a.length; c++) a[c].classList.remove(this.legendInactiveClass)
        }
      }, {
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          s.isRangeBar = "rangeBar" === a.chart.type && s.isBarHorizontal, s.hasXaxisGroups = "category" === a.xaxis.type && a.xaxis.group.groups.length > 0, s.hasXaxisGroups && (s.groups = a.xaxis.group.groups), t.forEach((function (t, e) {
            void 0 !== t.name ? s.seriesNames.push(t.name) : s.seriesNames.push("سری-" + parseInt(e + 1, 10))
          })), this.coreUtils.setSeriesYAxisMappings();
          var n = [],
            l = u(new Set(a.series.map((function (t) {
              return t.group
            }))));
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          d.push(l.config.chart.toolbar.export.csv.headerCategory), "boxPlot" === l.config.chart.type ? (d.push("minimum"), d.push("q1"), d.push("median"), d.push("q3"), d.push("maximum")) : "candlestick" === l.config.chart.type ? (d.push("open"), d.push("high"), d.push("low"), d.push("close")) : "rangeBar" === l.config.chart.type ? (d.push("minimum"), d.push("maximum")) : i.map((function (t, e) {
            ...
            l.globals.axisCharts && d.push(i.split(r).join("") ? i.split(r).join("") : "سری-".concat(e))
    ...
    _ = function () {
      ...
      return r(t, [{
        key: "niceScale",
        value: function (t, e) {
          var i, a, s, r, o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
            n = 1e-11,
            l = this.w,
            h = l.globals;
                ...
                for (var f = function (t) {
                    ...
                    h = e.series[c].group ? e.series[c].group : "axis-".concat(o), !(i.collapsedSeriesIndices.indexOf(c) < 0 && i.ancillaryCollapsedSeriesIndices.indexOf(c) < 0) || (i.allSeriesCollapsed = !1, n.forEach((function (t, a) {
                      if (e.series[c].group === t)
                        for (var o = 0; o < i.series[c].length; o++) {
                          var n = i.series[c][o];
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          var c = i.globals.yAxisScale[t].result.length - 1,
            ...
            u = i.globals.yAxisScale[t].result.slice();
    ...
    it = function () {
      ...
      return r(t, [{
        ...
        value: function () {
          ...
          var a = x.getLargestStringFromArr(i),
        ...
        value: function (t) {
          ...
          if ("heatmap" === e.config.chart.type || this.isBarsDistributed) {
            if (i) {
              ...
              this.ctx.events.fireEvent("legendHover", [this.ctx, a, this.w]), new W(this.ctx).highlightRangeInSeries(t, t.target)
            }
      ...
      return r(i, [{
        ...
        value: function (t, e) {
          ...
          a.globals.selection = l, "function" == typeof a.config.chart.events.selection && a.globals.selectionEnabled && (clearTimeout(this.w.globals.selectionResizeTimer), this.w.globals.selectionResizeTimer = window.setTimeout((function () {
            var t, e, o, n, l = i.gridRect.getBoundingClientRect(),
      ...
      return r(t, [{
        ...
        value: function (t, e, i) {
          ...
          if (a.yaxisTooltips[t] && o.length > 0) {
            ...
            var c = (e - l.top) * i.yRatio[0],
              d = r.maxYArr[h] - r.minYArr[h],
              g = r.minYArr[h] + (d - c);
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          return L = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(Y) : this.calculateColumnsDataLabelsPosition(Y), b.attr({
            ...
            x: L.dataLabelsX,
            y: L.dataLabelsY,
            val: this.barCtx.isRangeBar ? [r, o] : d[n][l],
            i: h,
            j: l,
            barWidth: u,
            barHeight: g,
        ...
        value: function (t) {
          ...
          h = Math.abs(h);
          var y, w, k = (n += o * l) - (this.barCtx.isRangeBar ? 0 : v) + l / 2 + c.height / 2 + b - 3,
            A = "start",
        ...
        value: function (t, i) {
          ...
          for (var n = 0, l = 0; n < t.length; n++, l++) {
            var h, c, d, g, u = void 0,
              ...
              w = this.barHelpers.getGroupIndex(v).columnGroupIndex,
              k = s.group({
            ...
            for (var T = 0; T < t[n].length; T++) {
              var z = this.barHelpers.getStrokeWidth(n, T, v),
                X = null,
                E = {
                  indexes: {
                    i: n,
        ...
        value: function (t, i) {
          ...
          for (var o = this.graphics.group({
              ...
              var c = void 0,
                ...
                g = void 0,
                u = void 0,
                p = s.globals.comboCharts ? i[r] : r,
                f = a.barHelpers.getGroupIndex(p),
                b = f.groupIndex,
                v = f.columnGroupIndex;
              ...
              var A = a.graphics.group({
                ...
                C = 0,
                L = 0,
                P = a.initialPositions(n, l, c, d, g, u, w);
              ...
              for (var M = 0; M < s.globals.dataPoints; M++) {
                var I = a.barHelpers.getStrokeWidth(r, M, p),
                  T = {
                    indexes: {
                      i: r,
                      j: M,
        ...
        value: function (t, i, a) {
          ...
          for (var c = o.group({
              ...
              var n, h, d, g, u = void 0,
                ...
                m = s.barHelpers.getGroupIndex(v).columnGroupIndex,
                y = o.group({
                  class: "apexcharts-series",
      ...
      return r(s, [{
        ...
        value: function (t, i) {
          ...
          for (var r = s.group({
            ...
            for (var A = s.group({
              ...
              var L, P = this.barHelpers.getStrokeWidth(n, C, p),
                M = this.seriesRangeStart[n][C],
                I = this.seriesRangeEnd[n][C],
                T = null,
                z = null,
                X = null,
                E = {
              ...
              var N = this.barHelpers.getPathFillColor(t, n, C, p),
                W = a.globals.stroke.colors[p];
        ...
        value: function (t) {
          var e = t.indexes,
            ...
            c = e.realIndex,
            d = e.j,
            g = l + a / this.invertedYRatio,
            u = l + s / this.invertedYRatio,
    ...
    return r(t, [{
      ...
      value: function (t, i, a, s) {
        ...
        if (void 0 !== (null === (r = o.config.series[0]) || void 0 === r ? void 0 : r.zIndex) && d.sort((function (t, e) {
          ...
          for (var R = d.length - 1; R >= 0; R--) h.add(d[R]);
        else
          for (var H = 0; H < d.length; H++) h.add(d[H]);
        return h
      }
    }, {
      ...
      value: function (t) {
        var e, i, a = this,
          ...
          X = p.pathFromLine,
          E = p.pathFromArea,
          Y = x.isNumber(L.globals.minYArr[n]) ? L.globals.minYArr[n] : L.globals.minY;
        o || (o = L.globals.dataPoints > 1 ? L.globals.dataPoints - 1 : L.globals.dataPoints);
        var F = function (t, e) {
            return e - t / M[l] + 2 * (a.isReversed ? t / M[l] : 0)
          },
          R = d,
          H = L.config.chart.stacked && !L.globals.comboCharts || L.config.chart.stacked && L.globals.comboCharts && (!this.w.config.chart.stackOnlyBar || "bar" === (null === (e = this.w.config.series[n]) || void 0 === e ? void 0 : e.type) || "column" === (null === (i = this.w.config.series[n]) || void 0 === i ? void 0 : i.type)),
          D = L.config.stroke.curve;
        ...
        switch (y) {
          case "monotoneCubic":
            ...
            switch (u) {
              ...
              case 2:
                var M = w ? n : n.slice().reverse(),
                  I = w ? P : P.slice().reverse(),
                  T = (k = I, M.map((function (t, e) {
                    return [t, k[e]]
                  })).filter((function (t) {
                    return null !== t[1]
                  }))),
      ...
      return r(t, [{
        ...
        value: function (t, e) {
          var i = this.w,
            ...
            f = void 0 !== a.chart.type ? a.chart.type : "line",
            x = null,
            b = 0;
        ...
        switch (t[0]) {
          ...
          case "A":
            e = function (t, e) {
              ...
              s = (new SVG.Matrix).rotate(T).scale(1 / M, 1 / I).rotate(-T), F = F.transform(s), R = R.transform(s), r = [R.x - F.x, R.y - F.y], n = r[0] * r[0] + r[1] * r[1], o = Math.sqrt(n), r[0] /= o, r[1] /= o, l = n < 4 ? Math.sqrt(1 - n / 4) : 0, z === X && (l *= -1);
