! function (e, t) {
    ...
    var Fe = "ژانویه_فوریه_مارس_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        Le = "ژانویه_فوریه_مارس_آپریل_مه_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        Ve = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        Ge = i,
        Ee = i;
    ...
    var Qe = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        Xe = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        Ke = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        et = i,
        tt = i,
        nt = i;
