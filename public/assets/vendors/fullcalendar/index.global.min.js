...
var FullCalendar = function (e) {
    ...
    function E(e, t, n, r, i) {
        ...
        else if ("o" === t[0] && "n" === t[1]) s = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + s] = n, n ? r || e.addEventListener(t, s ? D : S, s) : e.removeEventListener(t, s ? D : S, s);
    ...
    function T(e, t, n, r, i, s, o, a, l, c) {
        ...
        for (n.__k = [], h = 0; h < t.length; h++)
            ...
            } for (n.__e = b, h = D; h--;) null != S[h] && ("function" == typeof n.type && null != S[h].__e && S[h].__e == n.__d && (n.__d = O(r).nextSibling), j(S[h], S[h]));
        if (E)
    ...
    function N(e, t, r, i, s, o, a, l, c) {
        ...
        try {
            e: if ("function" == typeof _) {
                if (b = t.props, E = (d = _.contextType) && i[d.__c], S = d ? E ? E.props.value : d.__ : i, r.__c ? v = (u = t.__c = r.__c).__ = u.__E : ("prototype" in _ && _.prototype.render ? t.__c = u = new _(b, S) : (t.__c = u = new A(b, S), u.constructor = _, u.render = z), E && E.sub(u), u.props = b, u.state || (u.state = {}), u.context = S, u.__n = i, h = u.__d = !0, u.__h = [], u._sb = []), null == u.__s && (u.__s = u.state), null != _.getDerivedStateFromProps && (u.__s == u.state && (u.__s = f({}, u.__s)), f(u.__s, _.getDerivedStateFromProps(b, u.__s))), g = u.props, p = u.state, u.__v = t, h) null == _.getDerivedStateFromProps && null != u.componentWillMount && u.componentWillMount(), null != u.componentDidMount && u.__h.push(u.componentDidMount);
                else {
    ...
    }, s = !1, A.prototype.setState = function (e, t) {
        var n;
    ...
    }, A.prototype.render = y, o = [], l = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, _.__r = 0, c = 0;
    var W, L, F, V = [],
        G = [],
        Q = n.__b,
        q = n.__r,
    ...
    function re(e) {
        this.props = e
    }(re.prototype = new A).isPureReactComponent = !0, re.prototype.shouldComponentUpdate = function (e, t) {
    ...
    function Fr(e, t, n) {
        let {
            defs: r
        } = e, i = Dn(e.instances, e => r[e.defId].allDay ? e : Object.assign(Object.assign({}, e), {
            range: {
    ...
    class Wi {
        ...
        splitProps(e) {
            let t = this.getKeyInfo(e),
                ...
                l = {};
            this.eventUiBuilders = Dn(t, (e, t) => this.eventUiBuilders[t] || Gt(Li));
            for (let n in t) {
                let c = t[n],
                    d = s[n] || Ui,
        ...
        render() {
            ...
            return p(Ln.Consumer, null, n => {
                let {
                    ...
                    moreCnt: a
                } = e, l = Ao(e), c = "function" == typeof o ? o.call(s, a) : `+${a} ${o}`, d = at(i.moreLinkHint, [a], c), u = {
                    num: a,
                    shortText: "+" + a,
                    text: c,
                    view: r
                ...
                return p(y, null, Boolean(e.moreCnt) && p(Jn, {
                    ...
                    defaultGenerator: e.defaultGenerator || Do,
    ...
    function Qo(e, t, n, r) {
        ...
        switch (t.type) {
            ...
            case "FETCH_EVENT_SOURCES":
                return Xo(e, t.sourceIds ? An(t.sourceIds) : Jo(e, r), i, t.isRefetch || !1, r);
            case "RECEIVE_EVENTS":
    ...
    const ca = [Po({
        ...
        eventSourceDefs: [{
            ...
            fetch(e, t, n) {
                ...
                Ci(e.eventSource.meta.bind(null, Ai(e.range, r)), e => t({
                    rawEvents: e
                }), n)
            }
        }]
        ...
        propSetHandlers: {
            dateProfile: function (e, t) {
                t.emitter.trigger("datesSet", Object.assign(Object.assign({}, Ai(e.activeRange, t.dateEnv)), {
                    view: t.viewApi
                }))
            },
    ...
    class Qa {
        ...
        prepareHits() {
            this.offsetTrackers = Dn(this.droppableStore, e => (e.component.prepareHits(), new Va(e.el)))
        }
        releaseHits() {
            let {
                offsetTrackers: e
            ...
            for (let s in n) {
                ...
                if (a && a.isWithinClipping(e, t)) {
                    ...
                    if (l >= 0 && l < u && c >= 0 && c < h) {
                        ...
                        e && ar(e.dateProfile.activeRange, e.dateSpan.range) && (this.disablePointCheck || a.el.contains(document.elementFromPoint(l + n - window.scrollX, c + r - window.scrollY))) && (!i || e.layer > i.layer) && (e.componentId = s, e.context = o.context, e.rect.left += n, e.rect.right += n, e.rect.top += r, e.rect.bottom += r, i = e)
                    }
                }
            }
            return i
    ...
    function qa(e, t) {
        return !e && !t || Boolean(e) === Boolean(t) && Di(e.dateSpan, t.dateSpan)
    }
            ...
            this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = e => {
                ...
                e && (i = e.context, this.canDropElOnCalendar(n.subjectEl, i) && (s = function (e, t, n) {
                    ...
                    let {
                        refined: i,
                        extra: s
                    } = Dr(r, n), o = wr(i, s, t.sourceId, e.allDay, n.options.forceEventDuration || Boolean(t.duration), n), a = e.range.start;
    ...
    var _c = Po({
        ...
        views: {
            multiMonth: {
                component: class extends ls {
                    constructor() {
                        super(...arguments), this.splitDateProfileByMonth = Gt(Ac), this.buildMonthFormat = Gt(Rc), this.scrollElRef = {
                            current: null
    ...
    }, e.version = "6.1.14", Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});