...
(function( factory ) {
				...
				$( rowOne[0] ).children('th, td').each( function (i, cell) {
					...
					if ( col.mData === i ) {
						...
						if ( sort !== null || filter !== null ) {
							col.mData = {
								_:      i+'.display',
								sort:   sort !== null   ? i+'._40data-'+sort   : undefined,
								type:   sort !== null   ? i+'._40data-'+sort   : undefined,
								filter: filter !== null ? i+'._40data-'+filter : undefined
							};
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 */
			 "sEmptyTable": "داده ای در این جدول در دسترس نیست",
			 ...
			 */
			 "sInfoFiltered": "(فیلتر شده برای _MAX_ مورد(کل موارد) )",
